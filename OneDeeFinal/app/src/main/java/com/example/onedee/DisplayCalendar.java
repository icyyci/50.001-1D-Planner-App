...
import com.example.onedee.ui.home.HomeViewModel;
...
public class DisplayCalendar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_todo_list, R.id.nav_group_meetings, R.id.nav_logout)
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.display_calendar, menu);
        return true;
    }
